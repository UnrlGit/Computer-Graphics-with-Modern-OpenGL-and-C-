...
{
	dirLight->UseLight(uniformDirectionalLight.uniformAmbientIntensity, uniformDirectionalLight.uniformColour,
...
void Shader::CompileShader(const char * vertexCode, const char * fragmentCode)
{
	...
	// this and for loop underneath are for point lights
	...
	// this and for loop underneath are for spot lights
